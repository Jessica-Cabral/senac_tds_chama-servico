    ...
    <p class="form-title">*Edite o seu Cadastro</p>
     ...
     <img src='.$valor->foto_perfil.' alt="Foto do Perfil" class="perfil-img">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="nomeCompleto" name="nome" value='.$valor->nome.' required>
      </div>
      ...
      <div class="mb-3">
        ...
        <input type="date" class="form-control" id="dataNascimento" name="data_nascimento" value= '.$valor->data_nascimento.'  required>
      </div>
      ...
      <div class="mb-3">
        ...
        <input type="email" class="form-control" id="email" name="email" value='.$valor->email.' required>
      </div>
       <div class="check">
                    <input type="checkbox" value='.$valor->cliente.' name="cliente" id="cliente" style="width: 13px; height: 13px;">
                    <label for="cliente" style="color: #3d3d3d;">Cliente</label>
                    <input type="checkbox" value='.$valor->prestador.' name="prestador" id="prestador" style="width: 13px; height: 13px;">
